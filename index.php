...
<div class="container-fluid">
    ...
    <div class="row" style="margin-left:0;margin-right:0;">
        ...
        <div class="jumbotron daftar">
            ...
            <div class="form-group">
                    <label for="exampleInputEmail1">Pilih Program</label>
            <select name="no_jaket" class="form-control" required>
                  <option value="0"> -- Pilih Program Kesetaraan -- </option>
        ...
        <div class="jumbotron login">
            <div class="header">
                <h3 style="color:white"><center>Masuk Calon Pendaftar</center></h3>
            </div>
            <hr style="border:1px solid black">
