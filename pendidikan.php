  ...
  <div class="container">
    ...
    <legend>Halaman Utama</legend>
      ...
      <form action="" method="post">
        ...
        <div class="form-group">
          <label for="exampleInputEmail1">Status Sekolah Asal</label>
          <select name="status" class="form-control">
            <option value="0">-- Pilih Status Sekolah Asal --</option>
        ...
        <div class="form-group">
          ...
          <input type="text" name="namaslta" class="form-control"  placeholder="Nama Sekolah Asal">
        </div>
